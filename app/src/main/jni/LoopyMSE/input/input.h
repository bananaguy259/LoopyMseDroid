...
/**
 * input.h (Android version)
 *
 * Identical to upstream, plus set_controller_state_raw() for Android virtual gamepad.
 */
...
/** Direct PadButton injection for virtual gamepad — Android only. */
